...
def load_assets():
    ...
    original_images = {
        ...
        "level_select_transparent": pygame.image.load("../RayRhythm/graphics/low_opacity_bg.png"),
        ...
        "arrow_right": pygame.image.load("../RayRhythm/graphics/arrow-right.png"),
        "arrow_left": pygame.image.load("../RayRhythm/graphics/arrow-left.png"),
